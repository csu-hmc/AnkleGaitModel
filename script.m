...
problem.N = 20;					% use this number of nodes (optim will reduce this to number of gait samples, if needed
...
problem.L_u3 = -50.0;       problem.U_u3 = 100.0;        %(NM-added u3 lower and upper bounds to the problem statement)

% weights for cost function
problem.w1 				= 10.;			% weight for angle tracking term
...
problem.w5              = 0.01;          % weight for the pump controller (NM)
