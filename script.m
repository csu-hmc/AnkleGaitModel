...
problem.initialguess = 'initialguess1.mat';
...
problem.N = 25;					% use this number of nodes (optim will reduce this to number of gait samples, if needed
...
problem.wreg 			= 1e-6;			% weight for regularization (smoo thness) term
