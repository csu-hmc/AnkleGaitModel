...
%=================================NM======================================
problem.N = 75;					% use this number of nodes (optim will reduce this to number of gait samples, if needed)
%=================================NM======================================
...
problem.L_u3 = 0.001;       problem.U_u3 = 1.0;         %(NM-added u3 lower and upper bounds to the problem statement)
...
problem.w5              = 0.1;           % weight for the pump controller (NM)
